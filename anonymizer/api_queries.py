...
def check_location_exists_and_population_size(location, country):
	...
	api_url = 'http://api.geonames.org/searchJSON?name='+location+'&name_equals='+location+'&maxRows=1&orderby=population&isNameRequired=true&username='+'hiteshagarwal'
...
def find_names_in_list_string(list_potential_names):
    ...
    '''
    API_KEY = '5f5ca7fcfec048b1bce8dd949c9d6edd'
